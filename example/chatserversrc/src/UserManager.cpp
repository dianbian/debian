...
#include <sstream>
#include <stdio.h>
#include "mysqlLib/databasemysql.h"
#include "Logging.h"
...
{  
    ...
    QueryResult* pResult = pConn->Query("SELECT f_user_id, f_username, f_nickname, f_password, f_facetype, f_customface, f_gender, f_birthday, f_signature, f_address, f_phonenumber, f_mailFROM t_user ORDER BY f_user_id DESC");
    if (NULL == pResult)
    {
